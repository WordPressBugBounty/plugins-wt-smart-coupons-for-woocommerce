...
if ( !class_exists( '\\Wtpdf\\Banners\\Wt_Bfcm_Twenty_Twenty_Four' ) ) {
    ...
    class Wt_Bfcm_Twenty_Twenty_Four {
        ...
        private static $promotion_link = "https://www.webtoffee.com/plugins/?utm_source=BFCM_promotion&utm_medium=smart_coupon&utm_campaign=BFCM-Promotion";
                        ...
                        <div class="wt-bfcm-banner-body">
                            ...
                            <div class="wt-bfcm-banner-body-info">
                                ...
                                <div class="info">
                                    <p><?php 
                                        echo sprintf(
                                                __( 'Your Last Chance to Avail %1$s on WebToffee Plugins. Grab the deal before it`s gone!', 'wt-smart-coupons-for-woocommerce' ), 
                                                '<span>30% '.__("OFF","wt-smart-coupons-for-woocommerce" ).'</span>'
                                            );
                                    ?></p>
                                </div>
