...
if ( isset( $_GET['wbte_bogo_id'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
	$wbte_coupon    = new WC_Coupon( absint( wp_unslash( $_GET['wbte_bogo_id'] ) ) ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound, WordPress.Security.NonceVerification.Recommended
	$wbte_coupon_id = $wbte_coupon->get_id();  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
...
$wbte_discount_tag_img = '<img src="' . esc_url( $admin_img_path ) . 'bogo_discount_tag.svg" alt="' . esc_attr__( 'Discount tag', 'wt-smart-coupons-for-woocommerce' ) . '">';  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
require_once plugin_dir_path( __FILE__ ) . '--bogo-main-general.php';
$wbte_all_bogo_coupon_count = self::get_total_bogo_counts();  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
?>
<div class="wbte_sc_bogo_body">
	...
	if ( 0 < $wbte_all_bogo_coupon_count ) {
		...
		<div class="wbte_sc_bogo_sidebar">
			<?php
			$wbte_premium_url = esc_url( 'https://www.webtoffee.com/product/smart-coupons-for-woocommerce/?utm_source=free_plugin_bogo_sidebar&utm_medium=smart_coupons_basic&utm_campaign=smart_coupons&utm_content=' . WEBTOFFEE_SMARTCOUPON_VERSION );  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
